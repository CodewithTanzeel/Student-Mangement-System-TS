...
// U Guys might be wondering about that in this class there is not any code or program written we are using extend property to copy all the attributes defined in class of Student.
